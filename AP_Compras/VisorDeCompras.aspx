<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisorDeCompras.aspx.cs" Inherits="AP_Compras_VisorDeCompras" %>
...
<body>
    ...
    &nbsp;
        ...
        &nbsp;&nbsp;     
        <asp:ImageButton ID="ImprimeReporteDeCompras" runat="server" ImageUrl="~/Iconos/Impresora.gif" Width="42px" OnClick="ImprimeReporteDeCompras_Click" Height="27px" ToolTip="Click para Imprimir Reporte General de Compras"   />
        &nbsp;&nbsp;&nbsp;     
        <asp:ImageButton ID="ImprimeReporteRetencionesIVA" runat="server" ImageUrl="~/Images/Reporte2.png" Width="42px" Height="27px" ToolTip="Click para Imprimir Retenciones de IVA en Compras" OnClick="ImprimeReporteRetencionesIVA_Click"   />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
        <asp:ImageButton ID="ImprimeReporteRetencionesIR" runat="server" ImageUrl="~/Images/Factura.png" Width="42px" Height="27px" ToolTip="Click para imprimir reporte de Retenciones IR" OnClick="ImprimeReporteRetencionesIR_Click"   />
        <br />
        <br />
        <CR:CrystalReportViewer ID="cr_Compras" runat="server" ReportSourceID="ds_Compras" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasSearchButton="False" />
        <br />
        <CR:CrystalReportViewer ID="cr_RetenIVA" runat="server" ReportSourceID="ds_RetenIVA" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasSearchButton="False" />
        <br />
        ...
        <br />
        <br />
        <CR:CrystalReportSource ID="ds_Compras" runat="server">
            <Report FileName="ReporteDeCompras.rpt">
                <DataSources>
        ...
        <CR:CrystalReportSource ID="ds_RetenIVA" runat="server">
            <Report FileName="ReporteRetencionesIVAEntreFechas.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SoftempBD" TableName="VistaSolAyuda" />
                </DataSources>
                <Parameters>
        ...
        <CR:CrystalReportSource ID="ds_RetenIR" runat="server">
            <Report FileName="ReporteRetencionesIREntreFechas.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SoftempBD" TableName="VistaSolAyuda" />
                </DataSources>
                <Parameters>
