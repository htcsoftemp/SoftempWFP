<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisorDeComprasA.aspx.cs" Inherits="AP_Compras_VisorDeCompras" %>
...
<body>
    ...
    &nbsp;
        ...
        &nbsp;&nbsp;&nbsp;     
        <asp:ImageButton ID="ImprimeReporteRetencionesIVA" runat="server" ImageUrl="~/Images/Reporte2.png" Width="42px" Height="27px" ToolTip="Click para Imprimir Retenciones de IVA en Compras"   />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
        <asp:ImageButton ID="ImprimeReporteRetencionesIR" runat="server" ImageUrl="~/Images/Factura.png" Width="42px" Height="27px" ToolTip="Click para imprimir reporte de Retenciones IR"   />
        <br />
        <br />
        <CR:CrystalReportViewer ID="cr_Compras" runat="server" ReportSourceID="ds_Compras" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasSearchButton="False" PageZoomFactor="50" />
        <br />
        <br />
        <br />
        <br />
