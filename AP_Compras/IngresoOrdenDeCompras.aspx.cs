...
public partial class IngresoOrdenDeCompras : System.Web.UI.Page
{
...
//    static decimal ValorServicios, IVAServicios, PorcenIVAS, IVARetenS, PorcenIRS, IRRetenS,BaseIRS;
...
//    static string CuentaRetenIVA, CuentaRetenIR;
    ...
    static decimal  Subtotal, TotalICE;
...
//   NumComprobDiario NCD;
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            || String.IsNullOrEmpty((string)(Session["GrupoU"])))
        {
            ...
            btn_NuevoComprobante.Enabled = false;
 //           OcultaDiario();
            OcultaDatosBenef();
...
//        btn_HabilitaModifDatosProv.Visible = false;
 ...
 //       tbx_NumAutorFuente.Visible = true;
    ...
    private void DesplegaDatosFuente()
    {
        ...
        ESubtotal.Visible = true;
        tbx_Subtotal.Visible = true;
    ...
    private void OcultaDatosFuente()
    {
        ...
        EMontoP.Visible = false;
        tbx_TotalParcial.Visible = false;
        ...
        ESubtotal.Visible = false;
        tbx_Subtotal.Visible = false;
    ...
    protected void GrabarComprobante_Click(object sender, ImageClickEventArgs e)
    {
        RA = new RegistraAccesos((string)(Session["CodUsuarioM"]), (string)(Session["FechaProceso"]), DateTime.Now,
            (string)(Session["IPCliente"]), (string)(Session["IPCliente"]),
            System.Reflection.MethodBase.GetCurrentMethod().Name,
 ...
 //           btn_RegistraBenef.Visible = true;
        ...
        {
            MensajeR.Text = "BENEFICIARIO NO REGISTRADO, INGRESE DATOS DEL BENEFICIARIO";
            btn_HabilitaIngresoBenef.Visible = true;
            btn_RegistraBenef.Visible = true;
        }
    }
...
//            CalculaFactura();
 ...
 //                   ActualDocFinancieroEmitido();
    ...
    protected void tbx_NumDoc1_TextChanged(object sender, EventArgs e)
    {

    }

    protected void tbx_DetalleComprob_TextChanged(object sender, EventArgs e)
    {

    }

    protected void tbxCodProducto0_TextChanged(object sender, EventArgs e)
    {

    }

    protected void tbx_Cantidad0_TextChanged(object sender, EventArgs e)
    {

    }

    protected void btn_GrabarLineaOrden_Click(object sender, ImageClickEventArgs e)
    {

    }

    protected void btn_GrabarOrden_Click(object sender, ImageClickEventArgs e)
    {
