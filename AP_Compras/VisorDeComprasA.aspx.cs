        ...
        using (SqlConnection conn = new SqlConnection(DatabaseConnectionString))
        {
            try
            {
                ...
                sql = "CREATE VIEW [AContabilidad].[VistaCompras] AS SELECT "
                    ...
                    + "FROM AContabilidad.APContabCompras CROSS JOIN ASeguridad.DatosEmpresa "
...
WHERE        (AContabilidad.APContabCompras.fechaRegistro BETWEEN '01/05/2017' AND '31/05/2017') AND (AContabilidad.APContabCompras.idProv <> '9999999999999')
    */
}