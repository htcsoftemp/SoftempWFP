<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisorSolicitudAprobada.aspx.cs" Inherits="AP_Ayudas_VisorSolicitudAprobada" %>
...
<body>
    ...
    <asp:TextBox ID="MensajeR" runat="server" Width="352px"></asp:TextBox> 
        <input id="CLOSE0" type="button" value="       Cerrar" onclick="cerrar();" style="background-position: left; background-image: url('../Iconos/Salir.gif'); font-size: small; color: #FF0000; height: 21px; width: 100px; background-color: #FFFF00; background-repeat: no-repeat; font-family: Arial, Helvetica, sans-serif; font-style: normal; font-weight: bold; text-align: right;"/><CR:CrystalReportViewer ID="SolicitudAprobada" runat="server" ReportSourceID="FuenteSolicitudAprobada" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasSearchButton="False" PageZoomFactor="50" />
        <CR:CrystalReportSource ID="FuenteSolicitudAprobada" runat="server">
            <Report FileName="SolicitudAyudaAprob.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SoftempBD" TableName="VistaAprobAyuda" />
                </DataSources>
                <Parameters>
