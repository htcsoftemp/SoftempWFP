<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisorAyudaFacturas.aspx.cs" Inherits="AP_Ayudas_VisorAyudaFacturas" %>
...
<body>
    ...
    &nbsp;<asp:ImageButton ID="BuscarFacturasSolicitud" runat="server" ImageUrl="~/Iconos/Binoculares.gif" OnClick="BuscarFacturasSolicitud_Click" style="width: 16px"   />
    &nbsp;<asp:TextBox ID="MensajeR" runat="server" Width="352px"></asp:TextBox> 
        <input id="CLOSE0" type="button" value="       Cerrar" onclick="cerrar();" style="background-position: left; background-image: url('../Iconos/Salir.gif'); font-size: small; color: #FF0000; height: 21px; width: 100px; background-color: #FFFF00; background-repeat: no-repeat; font-family: Arial, Helvetica, sans-serif; font-style: normal; font-weight: bold; text-align: right;"/><CR:CrystalReportViewer ID="SolicitudAyuda" runat="server" ReportSourceID="FuenteAyudaFacturas" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasSearchButton="False" PageZoomFactor="50" />
        <CR:CrystalReportSource ID="FuenteAyudaFacturas" runat="server">
            <Report FileName="SolicitudAyudaFacturas.rpt">
                <DataSources>
